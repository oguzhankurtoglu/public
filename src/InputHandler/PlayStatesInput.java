...
public class PlayStatesInput implements InputProcessor { //oyun akışında ekran dokunuşlarına göre koordinatları, playerin koordinatları döndürülür.
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        playState.getGameWorld().getController().setEndKord(new Vector2(playState.getGameWorld().getController().getEndKord()));
        return false;
    }
    @Override
