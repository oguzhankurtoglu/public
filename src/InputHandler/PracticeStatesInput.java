...
public class PracticeStatesInput implements InputProcessor {
    ...
    public boolean touchUp(int screenX, int screenY, int pointer, int button) {
        ...
        practiceState.getPracticeWorld().getController().setEndKord(new Vector2(practiceState.getPracticeWorld().getController().getEndKord()));//farklı platformlar için koordinatları Gdx.graphics.getWidth methodu ile alabiliriz
